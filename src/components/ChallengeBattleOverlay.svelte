...
{#if battle}
  <div class="fixed inset-0 z-[70]" style="background: #16121a;">
    <QuickBattleView
      team1={[{ results: battle.you.results, name: battle.you.name, shareId: battle.you.shareId, portraitUrl: battle.you.portraitUrl ?? null }]}
      team2={[{ results: battle.opponent.results, name: battle.opponent.name, shareId: battle.opponent.shareId, portraitUrl: battle.opponent.portraitUrl ?? null }]}
