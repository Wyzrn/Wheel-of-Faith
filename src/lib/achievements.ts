...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'first_save_slot', name: 'New Beginnings', description: 'Create a Ascension save slot.',
  ...
  { id: 'all_slots', name: 'Multi-Saver', description: 'Create all 4 Ascension save slots.',
  ...
  { id: 'first_story_slot', name: 'Storied Beginning', description: 'Open your first Ascension save slot.',
  ...
  { id: 'two_slots_active', name: 'Multi-Tasker', description: 'Have 2 Ascension save slots in progress.',
