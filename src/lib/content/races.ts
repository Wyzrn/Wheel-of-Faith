...
export const races: Race[] = [
  ...
  // Nen User (Hunter × Hunter)
  {
    ...
    classPool: [
      { label: 'Enhancer',    weight: 4, element: 'Earth', grade: 'C', abilities: [{ label: 'Physical Amplification', weight: 2 }, { label: 'Healing Rate Surge', weight: 2 }, { label: 'Nen Reinforcement', weight: 2 }, { label: 'Durability Push', weight: 2 }, { label: 'Gyo Combat', weight: 2 }, { label: 'Simple But Effective', weight: 1 }], powerPool: [{ label: 'Super Strength', weight: 3 }, { label: 'Healing Factor', weight: 3 }, { label: 'Invulnerability', weight: 2 }, { label: 'Indomitable Rage', weight: 2 }, { label: 'Warrior Trance', weight: 1 }] },
      { label: 'Emitter',     weight: 3, element: 'Arcane', grade: 'C', abilities: [{ label: 'Ranged Nen Control', weight: 2 }, { label: 'Projectile Aim', weight: 2 }, { label: 'Energy Dispersion', weight: 2 }, { label: 'Detached Aura', weight: 2 }, { label: 'Long-Range Hatsu', weight: 2 }, { label: "Emitter's Eye", weight: 1 }], powerPool: [{ label: 'Ki Blast', weight: 3 }, { label: 'Pyrokinesis', weight: 3 }, { label: 'Electrokinesis', weight: 2 }, { label: 'Cryokinesis', weight: 2 }, { label: 'Plasma Generation', weight: 1 }] },
      { label: 'Transmuter',  weight: 3, element: 'Chaos', grade: 'C', abilities: [{ label: 'Form Lock', weight: 2 }, { label: 'Property Transfer', weight: 2 }, { label: 'Illusion Layer', weight: 2 }, { label: 'Frequency Shift', weight: 2 }, { label: 'Speed of Thought Shift', weight: 2 }, { label: 'Identity Change', weight: 1 }], powerPool: [{ label: 'Transmutation', weight: 3 }, { label: 'Shapeshifting', weight: 3 }, { label: 'Mimicry', weight: 2 }, { label: 'Molecular Vibration', weight: 2 }, { label: 'Atomic Restructuring', weight: 1 }] },
      { label: 'Manipulator', weight: 3, element: 'Psychic', grade: 'C', abilities: [{ label: 'Puppet Protocol', weight: 2 }, { label: 'Command Implant', weight: 2 }, { label: 'Aura Interference', weight: 2 }, { label: 'Object Binding', weight: 2 }, { label: 'Remote Gyo', weight: 2 }, { label: 'Hivemind Trace', weight: 1 }], powerPool: [{ label: 'Telekinesis', weight: 3 }, { label: 'Neural Hijack', weight: 3 }, { label: 'Telepathy', weight: 2 }, { label: 'Mind Control', weight: 2 }, { label: 'Psychic Dominion', weight: 1 }] },
  ...
  // Symbiote (Marvel)
  {
    ...
    subTypePool: [
      { label: 'Venom Symbiote',    weight: 4, element: 'Void', grade: 'B', abilities: [{ label: 'We Are Venom Aura', weight: 2 }, { label: 'Tongue Lash', weight: 2 }, { label: 'Spider-Sense Block', weight: 2 }, { label: 'Lethal Protector Mode', weight: 2 }, { label: 'Klyntar Merge Control', weight: 2 }, { label: 'Hunger Surge', weight: 1 }], grantedPowers: ['Venom Injection', 'Web Slinging'] },
      { label: 'Carnage Symbiote',  weight: 3, element: 'Blood', grade: 'B', abilities: [{ label: 'Chaotic Shard Launch', weight: 2 }, { label: 'Unhinged Bond', weight: 2 }, { label: 'Frenzy Mode', weight: 2 }, { label: 'Spawn Tendrils (Instant)', weight: 2 }, { label: 'Rage Amplification', weight: 2 }, { label: 'No Restraint Protocol', weight: 1 }], grantedPowers: ['Symbiote Tendrils'] },
      { label: 'Anti-Venom Symbiote', weight: 2, element: 'Light', grade: 'B', abilities: [{ label: 'Toxin Cleanse', weight: 2 }, { label: 'Healing Surge', weight: 2 }, { label: 'Pathogen Immunity', weight: 2 }, { label: 'White Symbiote Form', weight: 2 }, { label: 'Anti-Lethal Field', weight: 2 }, { label: 'Purity Burst', weight: 1 }] },
      { label: 'Toxin Symbiote',    weight: 2, element: 'Poison', grade: 'B', abilities: [{ label: 'Venom Resistance', weight: 2 }, { label: 'Poison Adaptation', weight: 2 }, { label: 'Toxin Injection (Passive)', weight: 2 }, { label: 'Dangerous Balance', weight: 2 }, { label: 'Erratic Combat', weight: 2 }, { label: 'Unstable Bond Power', weight: 1 }], grantedPowers: ['Venom Injection'] },
      { label: 'Scream Symbiote',   weight: 2, element: 'Sound', grade: 'B', abilities: [{ label: 'Sonic Immunity (Partial)', weight: 2 }, { label: 'Sonic Burst Weapon', weight: 2 }, { label: 'Pheromone Manipulation', weight: 2 }, { label: 'Chaotic Frenzy', weight: 2 }, { label: 'Predator Call', weight: 2 }, { label: 'Sound Shaping', weight: 1 }] },
  ...
  // Devil Fruit User (One Piece)
  {
    ...
    classPool: [
      { label: 'Paramecia (Body / Environment)', weight: 6, element: 'Chaos', grade: 'C', abilities: [{ label: 'Body Awakening Trace', weight: 2 }, { label: 'Passive Aura Field', weight: 2 }, { label: 'Environment Alteration', weight: 2 }, { label: 'Durability Through Modification', weight: 2 }, { label: 'Fruit Sense', weight: 2 }, { label: 'Paramecia Resilience', weight: 1 }], powerPool: [{ label: 'Transmutation', weight: 3 }, { label: 'Shapeshifting', weight: 3 }, { label: 'Molecular Vibration', weight: 2 }, { label: 'Rubber Body', weight: 2 }, { label: 'Probability Manipulation', weight: 1 }] },
  ...
  // ── Legendary (weight 1–2, abilitySpinCount 3–4) ──
  {
    ...
    classPool: [
      ...
      { label: 'Officer',          weight: 3, element: 'Neutral', grade: 'B', statBonusGrants: { fightingSkill: 'statBonus' }, abilities: [{ label: 'Command Training', weight: 2 }, { label: 'Leadership Edge', weight: 2 }, { label: 'Strategy Combat', weight: 2 }, { label: 'Squad Bond', weight: 2 }, { label: 'Veteran Form', weight: 2 }, { label: "Officer's Pride", weight: 1 }], powerPool: [{ label: 'Kryptonian Martial Arts', weight: 3 }, { label: 'Super Strength', weight: 3 }, { label: 'Battle Precognition', weight: 2 }, { label: 'Warrior Trance', weight: 2 }, { label: 'Invulnerability', weight: 1 }] },
      { label: 'High Commander',   weight: 2, element: 'Neutral', grade: 'A', statBonusGrants: { strength: 'statBonus', fightingSkill: 'statBonus' }, abilities: [{ label: 'Planetary Threat Level', weight: 2 }, { label: 'War Doctrine Master', weight: 2 }, { label: 'Viltrum Elite Combat', weight: 2 }, { label: 'Sovereign Strike', weight: 2 }, { label: 'Authority Aura', weight: 2 }, { label: "Empire's Champion", weight: 1 }], powerPool: [{ label: 'Kryptonian Martial Arts', weight: 3 }, { label: 'Solar Flare', weight: 3 }, { label: 'Super Strength', weight: 2 }, { label: 'Invulnerability', weight: 2 }, { label: 'War God Strike', weight: 1 }] },
  ...
  },
  {
    ...
    classPool: [
      ...
      { label: 'Valkyrie',      weight: 3, element: 'Light', grade: 'A', statBonusGrants: { fightingSkill: 'statBonus' }, abilities: [{ label: 'Chooser of the Slain', weight: 2 }, { label: 'Bifrost Rider', weight: 2 }, { label: 'Combat Grace', weight: 2 }, { label: 'Death Touch (Optional)', weight: 2 }, { label: 'Fallen Knight Reclaim', weight: 2 }, { label: 'Soul Guidance', weight: 1 }], powerPool: [{ label: 'Valkyrie Escort', weight: 3 }, { label: 'Einherjar Blessing', weight: 3 }, { label: 'Angelic Wings', weight: 2 }, { label: 'Flight', weight: 2 }, { label: 'Radiant Strike', weight: 1 }] },
      { label: 'Seiðr Mage',    weight: 3, element: 'Arcane', grade: 'B', statBonusGrants: { powerMastery: 'statBonus' }, abilities: [{ label: 'Runic Script', weight: 2 }, { label: 'Fate Reading', weight: 2 }, { label: 'Ward Binding', weight: 2 }, { label: 'Seiðr Trace', weight: 2 }, { label: 'Vólva Path', weight: 2 }, { label: 'Ancient Tongue', weight: 1 }], powerPool: [{ label: "Odin's Wisdom", weight: 3 }, { label: 'Ancient Seiðr (Conjure)', weight: 3 }, { label: 'Arcane Mastery', weight: 2 }, { label: 'Divination', weight: 2 }, { label: 'Reality Warping', weight: 1 }] },
      { label: 'Berserker (Úlfhéðinn)', weight: 2, element: 'Fire', grade: 'B', statBonusGrants: { strength: 'statBonus' }, abilities: [{ label: 'Wolf Bond', weight: 2 }, { label: 'Primal Fury', weight: 2 }, { label: 'Pain Suppress', weight: 2 }, { label: 'Frenzied State', weight: 2 }, { label: "Nature's Rage", weight: 2 }, { label: 'Ulfr Bite', weight: 1 }], powerPool: [{ label: 'Berserker Rage', weight: 3 }, { label: 'Berserker Frenzy', weight: 3 }, { label: 'Indomitable Rage', weight: 2 }, { label: 'Einherjar Blessing', weight: 2 }, { label: 'Super Strength', weight: 1 }] },
  ...
  },
  {
    ...
    subTypePool: [
      { label: 'Primordial of Chaos',  weight: 3, element: 'Chaos', grade: 'S', statBonusGrants: { powerMastery: 'statBonus', energyLevel: 'statBonus' }, abilities: [{ label: 'Chaos Incarnate', weight: 2 }, { label: 'Reality Flux', weight: 2 }, { label: 'Entropic Aura', weight: 2 }, { label: 'Dissolution Touch', weight: 2 }, { label: 'Probability Void', weight: 2 }, { label: 'Unmaking', weight: 1 }], powerPool: [{ label: 'Causality Violation', weight: 3 }, { label: 'Reality Warping', weight: 3 }, { label: 'Matter Disintegration', weight: 2 }, { label: 'Omnipotence (Weekend Only)', weight: 2 }, { label: 'Entropy Field', weight: 1 }] },
      { label: 'Primordial of Order',  weight: 2, element: 'Arcane', grade: 'S', statBonusGrants: { iq: 'statBonus', potential: 'statBonus' }, abilities: [{ label: 'Law Absolute', weight: 2 }, { label: 'Structure Mandate', weight: 2 }, { label: 'Reality Stabilization', weight: 2 }, { label: 'Cosmic Balance', weight: 2 }, { label: 'Pattern Lock', weight: 2 }, { label: 'Absolute Rule', weight: 1 }], powerPool: [{ label: 'Chronolock', weight: 3 }, { label: 'Temporal Stasis', weight: 3 }, { label: 'Reality Warping', weight: 2 }, { label: 'Omniscience (Partial)', weight: 2 }, { label: 'Time Stop', weight: 1 }] },
