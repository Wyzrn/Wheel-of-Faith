...
const RENAME_PAIRS: Array<[string, string]> = [
  ...
  ['Devil Fruit User',                      'Demon Fruit Eater'],
  ['Cursed Fruit Eater',                    'Demon Fruit Eater'],
  ['Devil Fruit',                           'Demon Fruit'],
  ['Cursed Fruit',                          'Demon Fruit'],
  ['One For All',                           'Apex Inheritance'],
  ['Detroit Smash',                         'City-Smash Strike'],
